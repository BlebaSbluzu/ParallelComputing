...
void decide_Z_to_R(int row, int col, int num_Susceptible_Neighbours,
                   CELL **current, CELL **future) {
    float probKill = BASE_PROB_Z_TO_R + (num_Susceptible_Neighbours - MIN_NUM_S_TO_KILL_Z) * EXTRA_PROB_Z_TO_R_PER_EXTRA_S;
